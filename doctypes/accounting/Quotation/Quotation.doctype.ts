export default $doctype<"Quotation">(
  {
    ...
    is_delivery_order: {
      type: "Check",
      label: "Is Delivery Order",
      default: "0",
      no_print: 1,
      description: "When set, Create Delivery Note is shown instead of Create Sales Invoice after submit.",
    },
    price_project: {
      type: "Reference",
      label: "Price Project",
    ...
    tabs: JSON.stringify([
      {
        ...
        layout: [
          ...
          [
            ...
            { type: "field", value: "is_delivery_order", align: "left" },
